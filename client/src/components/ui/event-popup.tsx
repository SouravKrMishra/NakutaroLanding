  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div 
            className="bg-[#1E1E1E] rounded-xl overflow-hidden border border-[#2D2D2D] shadow-xl max-w-2xl w-full mx-4"
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="mt-6 pt-6 border-t border-[#2D2D2D] flex justify-end">
                <button
                  onClick={onClose}
                  className="px-4 py-2 bg-accent hover:bg-accent/80 transition-colors duration-200 text-white rounded-md font-medium"
                >
                  Close
                </button>
              </div>
