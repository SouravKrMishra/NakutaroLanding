...
const testimonials = [
  {
    content:
      "Anime India has become my go-to source for everything anime in India. The community discussions are amazing, and I've found so many new series to watch through their recommendations. Their event listings also helped me attend my first cosplay convention!",
    author: "Priya Sharma",
  ...
  {
    content:
      "What sets Anime India apart is their detailed coverage of both popular and niche anime series. Their analysis of themes and cultural context has deepened my appreciation for anime as an art form. The forums are filled with passionate fans who are welcoming to newcomers.",
    author: "Arjun Kapoor",
  ...
  {
    content:
      "Being part of the Anime India community has connected me with fellow anime lovers across the country. The exclusive news and updates keep me informed about releases even before they're widely announced. Their anime meetups are always well-organized and fun!",
    author: "Nisha Patel",
  ...
  {
    content:
      "The merchandise quality from Anime India is outstanding. The products are authentic and reasonably priced, making it accessible for collectors like me. Their customer service team is also very responsive and helpful with any inquiries.",
  ...
  {
    content:
      "As someone new to anime, Anime India's beginner guides and recommendations have been invaluable. They make the vast world of anime approachable and exciting to explore. I appreciate how they cater to fans at all levels of experience.",
    author: "Ananya Desai",
  ...
  useEffect(() => {
    const updateSlideWidth = () => {
      if (sliderRef.current) {
        const firstSlide =
          sliderRef.current.querySelector(".testimonial-slide");
        if (firstSlide) {
  ...
  const socialLinks = [
    {
      ...
      url: "https://instagram.com/animeindia",
    },
    {
      name: "YouTube",
      icon: (
      ...
      url: "https://youtube.com/@animeindia",
    },
    {
      name: "Facebook",
      icon: (
      ...
      url: "https://facebook.com/animeindia",
    },
    {
      name: "Discord",
      icon: (
      ...
      url: "https://discord.gg/animeindia",
    },
    {
      name: "Linktree",
      icon: (
      ...
      url: "https://linktr.ee/animeindia",
    },
  ];
  ...
  return (
    <section id="testimonials" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#0A0A0A] overflow-hidden">
        ...
        <div className="absolute top-20 right-[15%] w-6 h-6 border border-accent/30 rounded-sm" />

        <div className="absolute bottom-32 left-[20%] w-8 h-8 border border-white/20 rounded-full" />

        <div className="absolute top-1/3 left-[10%] w-4 h-4 bg-accent/10 rounded-sm" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-accent">Members Say</span>
          </motion.h2>
          ...
          >
            Hear from passionate anime fans who are part of our growing
        ...
        {/* Main Testimonial */}
        <motion.div variants={fadeIn("up", "tween", 0.4, 1)} className="mb-14">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 relative z-10">
              <div className="lg:w-1/3 flex flex-col items-center lg:items-start">
                <div
                  ...
                  style={{
                    background:
                      testimonials[currentSlide].avatarBg ||
                ...
                <h3 className="text-xl font-bold text-white mb-1 text-center lg:text-left">
                  {testimonials[currentSlide].author}
                </h3>
                <p className="text-accent mb-3 text-sm text-center lg:text-left">
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold mb-4">
            ...
            <span className="text-accent">Anime Community</span>
          </h3>
          <p className="text-gray-300 max-w-2xl mx-auto mb-6">
            Connect with fellow anime enthusiasts, participate in discussions,
            get early access to events, and more!
          </p>
            ...
            <AnimatePresence>
              {showSocialLinks && (
                <motion.div
                  ...
                  className="flex flex-wrap justify-center gap-4 mt-4 overflow-hidden"
                >
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#1A1A1A] hover:bg-accent/20 text-gray-300 hover:text-accent transition-colors duration-300 border border-[#333] hover:border-accent/30"
                    >
                      {social.icon}
