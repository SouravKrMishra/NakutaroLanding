          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              <a
                ...
                className="px-8 py-3 bg-accent hover:bg-accent/80 text-white font-medium rounded-md transition duration-300 text-lg shadow-lg hover:shadow-xl inline-flex items-center justify-center click-shrink shine-effect"
              >
