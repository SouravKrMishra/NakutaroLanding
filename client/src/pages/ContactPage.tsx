...
const ContactPage = () => {
  ...
  //   {
  //     icon: <Mail className="w-full h-full text-accent/10" />,
  //     size: 48,
  //     delay: 0,
  //   },
  //   {
  //     icon: <Phone className="w-full h-full text-accent/10" />,
  //     size: 56,
  //     delay: 1.5,
  //   },
  //   {
  //     icon: <Clock className="w-full h-full text-accent/10" />,
  //     size: 64,
  //     delay: 0.8,
  //   },
  //   {
  //     icon: <MessageSquare className="w-full h-full text-accent/10" />,
  //     size: 52,
  //     delay: 2.2,
  //   },
  // ];
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              >
                Have questions or feedback? Contact our team at Anime India for
                any inquiries about our events, products, or services.
              </motion.p>
            </motion.div>
          </div>
        </div>
