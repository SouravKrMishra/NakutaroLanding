...
const reviews = [
  {
    ...
    content: "The figure's quality exceeds my expectations. The details are incredibly accurate and the paint work is flawless. Definitely worth the price!"
  },
  {
    id: 2,
    ...
    content: "Really happy with this purchase. The figure is well-made and looks exactly like the character. Packaging was secure and it arrived in perfect condition."
  },
  {
    id: 3,
    username: "OtakuWorld",
    ...
    content: "This is now the centerpiece of my collection. The attention to detail is remarkable. Highly recommend to any serious collector."
  }
];
...
const productDetails: Product[] = [
  {
    ...
    isNew: true,
    description: "High-quality PVC figure of Naruto Uzumaki in Sage Mode. This premium collectible stands 25cm tall and features incredible detail with a dynamic pose showcasing Naruto's Rasengan technique. The figure includes a detailed base with Japanese calligraphy and is made from high-grade materials.",
    attributes: {
      "Material": "PVC & ABS",
      "Height": "25cm",
      "Weight": "800g",
    ...
    specifications: {
      ...
      "Care Instructions": "Keep away from direct sunlight and extreme temperatures",
  ...
  },
  {
    ...
    description: "Premium quality Tanjiro Kamado statue from Demon Slayer, featuring incredible detail with Tanjiro in his iconic Water Breathing stance. The figure stands 30cm tall and comes with LED light effects in the base to highlight the water effects. Made with high-quality materials for a stunning display piece.",
    attributes: {
      "Material": "PVC & Resin",
      "Height": "30cm",
      "Weight": "1.2kg", 
    ...
    returnPolicy: "30-day return policy for unopened items",
    specifications: {
      "Box Contents": "Figure, Display Base with LED effects, Authentication Card, Batteries",
      "Care Instructions": "Keep away from direct sunlight and extreme temperatures",
      "Country of Origin": "Japan",
      "Warranty": "No manufacturer warranty"
    }
    ...
    <div className="product-detail-page pt-28 pb-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-6">
        <div className="flex items-center text-sm text-gray-400">
          ...
          <ChevronRight className="h-4 w-4 mx-2" />
          <a href={`/products?category=${currentProduct.category}`} className="hover:text-accent transition-colors">
            {currentProduct.category}
          </a>
          <ChevronRight className="h-4 w-4 mx-2" />
          <span className="text-gray-500 truncate max-w-[200px]">{currentProduct.name}</span>
        </div>
      </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                {currentProduct.images.map((image, index) => (
                  <button
                    ...
                    className={`bg-[#1E1E1E] rounded-md overflow-hidden border h-20 sm:h-24 hover:border-accent transition-colors ${
                      activeImage === index ? 'border-accent' : 'border-[#2D2D2D]'
                    }`}
                  >
                    <img 
                      src={image} 
          ...
          <div>
            ...
            {/* Product attributes */}
            <div className="mb-5 pb-5 border-b border-[#2D2D2D]">
              {currentProduct.attributes && Object.entries(currentProduct.attributes).length > 0 && (
                <div className="grid grid-cols-2 gap-4 mb-6">
                  {Object.entries(currentProduct.attributes).slice(0, 4).map(([key, value]) => (
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-gray-400">{currentProduct.returnPolicy}</div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-gray-400">{currentProduct.deliveryInfo}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="bg-[#1E1E1E] rounded-lg border border-[#2D2D2D] overflow-hidden">
          ...
          <div className="p-6">
            ...
            {activeTab === 'specifications' && (
              <div>
                {currentProduct.specifications && Object.entries(currentProduct.specifications).length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex-1">
                    <div className="space-y-2">
                      {[5, 4, 3, 2, 1].map(star => {
                        ...
                        const percentage = star === 5 ? 70 : star === 4 ? 20 : star === 3 ? 8 : star === 2 ? 1 : 1;
                ...
                <div className="p-4">
                  <a href={`/product/${product.id}`} className="block">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="font-bold text-accent whitespace-nowrap ml-2">{product.price}</span>
                    </div>
                  </a>
              ...
              <div className="p-3 md:p-4">
                <a href={`/product/${product.id}`} className="block">
                  <div className="flex justify-between items-start mb-1">
                    ...
                    <span className="font-bold text-sm text-accent whitespace-nowrap ml-2">{product.price}</span>
                  </div>
                </a>
